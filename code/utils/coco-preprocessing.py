...
if args.dataset == "all":
    ...
    coco, idmapper, cats = load_annotations(root_dir, "val2014")
    ...
    labels = load_labels(train_img_names, root_dir, "train", coco, idmapper)
    save_obj(labels, args.save_dir + "multi-label-train2014")
    LIST = "/Users/lindepav/Documents/GitHub/wang-multi-label-ood/datasets/coco/" + "train2014imgs.txt"
    wrrite(LIST, train_img_names)
